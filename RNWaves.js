/*
 * @Author: CrabMan 
 * @Date: 2019-11-01 11:14:40 
 * @Last Modified by: CrabMan
 * @Last Modified time: 2019-11-04 11:14:20
 */
...
const tempX1 = 25; // 波浪1的步长
const tempX2 = 50; // 波浪2的步长
const baseRatiio = 0.3; // 浪高比例
const isWave = true; // 浪吗?

export default class RNWaves extends React.Component {
    static propTypes = {
